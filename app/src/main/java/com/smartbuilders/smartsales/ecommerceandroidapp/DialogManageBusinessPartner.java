 ...
 */
public class DialogManageBusinessPartner extends DialogFragment {
    ...
    public DialogManageBusinessPartner() {
        // Empty constructor required for DialogFragment
    }

    public static DialogManageBusinessPartner newInstance(Product product, User user){
        DialogManageBusinessPartner editQtyRequestedDialogFragment = new DialogManageBusinessPartner();
