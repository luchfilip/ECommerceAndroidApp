 ...
 */
public class DialogUpdateProductToSale extends DialogFragment {
    ...
    public static DialogUpdateProductToSale newInstance(OrderLine orderLine, User user){
        DialogUpdateProductToSale dialogUpdateProductToSale = new DialogUpdateProductToSale();
        dialogUpdateProductToSale.mUser = user;
        dialogUpdateProductToSale.mOrderLine = orderLine;
        return dialogUpdateProductToSale;
    }
