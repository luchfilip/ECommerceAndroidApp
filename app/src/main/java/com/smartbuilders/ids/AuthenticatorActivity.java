...
public class AuthenticatorActivity extends AccountAuthenticatorActivity {
    ...
    public final static String STATE_USERNAME 		        = "com.smartbuilders.ids.AuthenticatorActivity.state_username";
    public final static String STATE_USER_PASS              = "com.smartbuilders.ids.AuthenticatorActivity.state_userpass";
    public final static String STATE_SERVER_ADDRESS         = "com.smartbuilders.ids.AuthenticatorActivity.state_serveraddress";
    public final static String STATE_USER_GROUP             = "com.smartbuilders.ids.AuthenticatorActivity.state_usergroup";
