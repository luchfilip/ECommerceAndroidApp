...
import com.smartbuilders.ids.database.DatabaseHelper;
...
public class DataBaseContentProvider extends ContentProvider implements OnAccountsUpdateListener {
	...
	public static final String KEY_USER_ID 						= "com.smartbuilders.ids.providers.DataBaseContentProvider.USER_ID";
	public static final String KEY_USER_DB_NAME 				= "com.smartbuilders.ids.providers.DataBaseContentProvider.USER_DB_NAME";
	public static final String KEY_USER_SAVE_DB_EXTERNAL_CARD 	= "com.smartbuilders.ids.providers.DataBaseContentProvider.USER_SAVE_DB_EXTERNAL_CARD";
    public static final String KEY_SEND_DATA_TO_SERVER			= "com.smartbuilders.ids.providers.DataBaseContentProvider.SEND_DATA_TO_SERVER";
